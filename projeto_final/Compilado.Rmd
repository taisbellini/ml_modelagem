...
barplot(table(data$Education),
   xlab="Education", col = brewer.pal(9, "Pastel1"), cex.names=0.5, las = 2, horiz = TRUE)
dev.off()
png('dist_pais.png')
par(mar=c(4,9,4,4))
...
barplot(table(data$cannabis_user),
   xlab="Cannabis User", col = c("green", "red"), names = c("Non-User", "User"), ylim= c(0,1000))
dev.off()
png('dist_user_ecstasy.png')
barplot(table(data$ecstasy_user),
   xlab="Ecstasy User", col = c("green", "red"), names = c("Non-User", "User"), ylim= c(0,1500))
dev.off()
png('dist_user_stimulating.png')
barplot(table(data$stimulating_user),
   xlab="Stimulating User", col = c("green", "red"), names = c("Non-User", "User"), ylim= c(0,1500))
dev.off()
